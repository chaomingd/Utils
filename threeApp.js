...
var APP = {
	...
	Player: function ({ dom, basePath, bgColor, alpha = 1, antialias = true }) {
		var loader = new THREE.ObjectLoader();
		if (basePath) {
			loader.setTexturePath(basePath)
		}
		...
		this.width = 500;
		this.height = 500;
		this.load = function (json, onLoad) {
			renderer = new THREE.WebGLRenderer({ antialias, alpha: true });
			// renderer = new THREE.WebGLRenderer({ alpha: true });
			renderer.setPixelRatio(window.devicePixelRatio);
			renderer.setClearColor(bgColor || json.scene.object.background || '#000000', alpha);
      ...
      delete json.scene.object.background
